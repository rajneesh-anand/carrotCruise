<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/MasterHome.master" AutoEventWireup="true" CodeBehind="AddAgent.aspx.cs" Inherits="Shipping.WebForms.AddAgent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">      
       ...
       <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <h3><span class="label label-primary">Create New Client Account</span></h3>
        </div>
             
        <div class="form-group col-md-6">
             <h6>Client First Name</h6>
             <asp:TextBox ID="txtName" class="form-control upper-case" runat="server"></asp:TextBox>   
        ...
        <div class="form-group col-md-12">
         ...
         <div class="form-group col-md-6">
             <h6>GSTIN</h6>
              <asp:TextBox ID="txtGST" runat="server" class="form-control upper-case"  onpaste="return false"> </asp:TextBox>
        </div>        
