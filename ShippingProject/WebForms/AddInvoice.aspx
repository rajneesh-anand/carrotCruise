<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/MasterHome.master" AutoEventWireup="true" CodeBehind="AddInvoice.aspx.cs" Inherits="Shipping.WebForms.AddInvoice" %>
...
<div class="form-row">
     ...
     <div class="form-group col-md-12 form-group-sm">
          <h4><span class="label label-primary">NEW INVOICE</span></h4>
     </div>
     ...
     <div class="form-group col-md-6 form-group-sm">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button id="btnSave" class="btn btn-info navbar-btn pull-right btn-space" >SAVE</button>
    ...
    $(document).ready(function () {
        ...
        $("#btnSave").click(function () {
            ...
            var ddlSearch = document.getElementById('<%=ddlSearch.ClientID %>');             
                    ...
                    console.log(data);
                    $.ajax({
                        url: 'AddInvoice.aspx/SaveInvoice',
                        type: 'POST',
                        dataType: 'json',
