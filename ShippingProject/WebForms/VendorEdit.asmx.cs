...
{
    /// <summary>
    /// Summary description for VendorEdit
    /// </summary>
    ...
    public class VendorEdit : System.Web.Services.WebService
    {

        [WebMethod]
        public void GetVendorByName(int AgentId)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("spVendorDetails", con);
                ...
                while (rdr.Read())
                {
                    ...
                    employee.phone = Convert.ToInt64(rdr["Phone"]);
