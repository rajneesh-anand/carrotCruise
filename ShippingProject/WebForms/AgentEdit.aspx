<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/MasterHome.master" AutoEventWireup="true" CodeBehind="AgentEdit.aspx.cs" Inherits="Shipping.WebForms.AgentEdit" %>
       ...
       <div class="form-row">
        ...
        <div class="form-group col-md-12">
         ...
         <button id="btnUpdate" class="btn btn-info navbar-btn pull-right btn-space">UPDATE</button>
           ...
           <asp:HiddenField ID="AgentValue" runat="server" />
       </div> 
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          $(function () {
              ...
              if (queryString["aid"] != null) {
                  //var data = "<u>Values from QueryString</u><br /><br />";
                  AgentID = queryString["aid"];
                  //$("h3").html(in_number);
              }
              ...
              $.ajax({
                  url: 'AgentEdit.asmx/GetAgentByName',
          ...
          $("#btnUpdate").click(function () {
              ...
              $.ajax({
                  url: 'AgentEdit.aspx/UpdateAgent',
                  type: 'POST',
                  dataType: 'json',
                  ...
                  success: function (response) {
                      ...
                      var url = "../WebForms/ListAgents.aspx";
